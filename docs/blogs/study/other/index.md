...
### 16. 布丁扫描（APP）
布丁扫描是一款真正免费的软件，里面没有任何扣费的项目，甚至连打赏页面都没有<br />
它和破解版的免费不同，它是官方免费的，而且<b>不限制使用次数</b>，除了AI绘画外(每日10次)<br />
布丁扫描上的功能相对很多免费的扫描软件来说，已经很丰富了。
常用的<b><font color=blue>文档扫描、证件扫描、文字提取、表格识别都有，而且还有AI绘画，试卷擦除，口算批改，拍照翻译，照片修复</font></b>这些实用的功能

#### 下载方式
+ iOS：App Store搜索“布丁扫描”
+ Android：手机应用市场搜索“布丁扫描”
+ [官网](http://www.budingscan.com/#/)

:::details 使用体验
<span style="background:#000;color:#fff;"><b>&nbsp; 1. 文档扫描-AI超清和去屏纹滤镜 &nbsp;</b></span><br />
文档扫描是扫描最常用的功能，布丁文档扫描必提两个滤镜功能，【AI超清】和【去屏纹】滤镜<br />
日常可以常用AI超清滤镜，能够应对多个复杂环境的扫描，还可以对文档矫正，消除文件上的阴影等，去除文件上的手指等，效果很明显，一定不要错过！
![avatar](/image/blogs/study/buildBlog/bd01.png)

经常对着电脑屏幕或者会议室屏幕拍文件的，可以用去屏纹滤镜，处理后可以有效的去除屏幕摩尔纹
<img src="/image/blogs/study/buildBlog/bd02.jpg" style="width: 400px;" />
文档扫描还有一个特点：<b><font color=red>导出文件不带有水印！</font></b>比很多付费软件良心太多！
<br />
<span style="background:#000;color:#fff;"><b>&nbsp; 2. 表格识别-一键提取图片表格 &nbsp;</b></span><br />
表格识别功能在工作中用的比较多，整理报表，制作简历，收集信息等，都可以通过表格识别，提取出文档中的表格，还可以对表格内的内容进行编辑，编辑后继续生成Excel表格或者PDF导出，能够提高效率的工具
<img src="/image/blogs/study/buildBlog/bd03.gif" style="width: 300px;" />
<br />
<span style="background:#000;color:#fff;"><b>&nbsp; 3. 试卷擦除+口算批改-家长和老师必备 &nbsp;</b></span><br />
家里有学生的，或者老师，一定要尝试下试卷擦除，它可以把一张写满答案的试卷去除手写笔记，还原成一张空白的试卷，用于复习，整理错题，也是非常的实用
<img src="/image/blogs/study/buildBlog/bd04.gif" style="width: 300px;" />
口算批改可以针对小学一、二、三年级口算题进行判断对错，勾选出错误答案并给出对应的正确答案，检查作业效率更高
![avatar](/image/blogs/study/buildBlog/bd05.png)
<br />

<span style="background:#000;color:#fff;"><b>&nbsp;4. 试AI绘画-免费的AI绘画工具 &nbsp;</b></span><br />
AI绘画是布丁扫描的特色功能，这个功能可以让布丁扫描从一众扫描工具中脱颖而出，打出差异化。无论新手还是老手，都可以下载体验下<br />
新玩家可以试下图生图，导入自己的照片生成二次元形象，用来做头像还是不错的
![avatar](/image/blogs/study/buildBlog/bd06.png)
进阶一些的，可以尝试输入描述词，生成对应的图片，用来做插图，甚至可以作为生产力工具
![avatar](/image/blogs/study/buildBlog/bd07.png)
<br />

<span style="background:#000;color:#fff;"><b>&nbsp;5. 证件扫描-生活必备 &nbsp;</b></span><br />
最后证件扫描这个功能，几乎是必备功能了，日常要用到的证件电子版都可以扫描保存下来，以备不时之需<br />
布丁里面的证件模板有身份证、银行卡（单卡证）、户口本（双拼）、护照，驾照，行驶证，营业执照等。使用这些模板扫描就可以生成在A4纸上对应的原件大小，电子打印件可以当原件的复印件来用
<img src="/image/blogs/study/buildBlog/bd08.gif" style="width: 300px;" />
需要证件三拼或者四拼的，也可以实现，比如身份证的正反面+银行卡，可以先在证件扫描那里把需要拼的证件扫描到一个文档，然后进入该文档点击下方的“拼图”就可以实现证件3拼或者4拼
<img src="/image/blogs/study/buildBlog/bd09.png" style="width: 300px;" />
:::
